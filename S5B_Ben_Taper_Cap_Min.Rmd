...
tom_finished <- tom_finished %>% 
  mutate(Income.Total = case_when(Demographic.FishyV3 == "Not so fishy" ~ Income.Total,
                                  TRUE ~ NA_real_)) %>% 
  mutate(Expenditure.Total = case_when(Demographic.FishyV3 == "Not so fishy" | Demographic.FishyV3 == "Timmy"~ Expenditure.Total,TRUE ~ NA_real_)) %>% 
  mutate(Expenditure.Flexible.Total.LoE = case_when(Demographic.FishyV3 == "Not so fishy"| Demographic.FishyV3 == "Timmy" ~ Expenditure.Flexible.Total.LoE,TRUE ~ NA_real_)) %>% 
    mutate(Expenditure.Flexible.Total.LCFS = case_when(Demographic.FishyV3 == "Not so fishy"| Demographic.FishyV3 == "Timmy" ~ Expenditure.Flexible.Total.LCFS,TRUE ~ NA_real_)) %>% 
  mutate(Expenditure.Fixed.Total = case_when(Demographic.FishyV3 == "Not so fishy" | Demographic.FishyV3 == "Timmy"~ Expenditure.Fixed.Total,TRUE ~ NA_real_)) %>% 
    mutate(Expenditure.Total.LCFS = case_when(Demographic.FishyV3 == "Not so fishy" | Demographic.FishyV3 == "Timmy"~ Expenditure.Total.LCFS,TRUE ~ NA_real_)) 
