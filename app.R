                ...
                fluidRow(column(selectInput(inputId = "Variable1",
                         ...
                         column(selectInput(inputId = "Variable2",
                                            ...
                                            choices = c("Demographic.Age.Group.HRP", "Demographic.Age.Partner", "Demographic.Age.Respondent", 
                                                        ...
                                                        "Demographic.Fishy", "Demographic.Housing", "Demographic.Housing.Benefit", "Demographic.Housing.Tenure.LCFS", 
                                                        ...
                                                        "Demographic.UC", "Demographic.WTC", "Demographic.ethnicity.HRP", "Demographic.ethnicity.HRP.Partner", "Demographic.Household.Type.LCFS")), width = 6)),
              ...
              fluidRow(
                ...
                column(width = 6,
                       selectInput(inputId = "Tab4Variable2",
                                   ...
                                   choices = c("Surplus", "Expenditure.Comms.Mobile.Phone", 
                                               ...
                                               "Expenditure.Personal.Cost", "Expenditure.Personal.MART", "Expenditure.Rent", "Expenditure.Rent.Net", "Expenditure.Total", "Expenditure.Transport", 
