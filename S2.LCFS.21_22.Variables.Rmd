...
LCFS_benefits_22_24 <- rbind(LCFS_benefits_22,LCFS_benefits_23, LCFS_benefits_24)
```

```{r}
LCFS_benefits_22_24 <- LCFS_benefits_22_24 %>%
...
LCFS_benefits_22_24<-LCFS_benefits_22_24 %>% select("case", "Year", 
         "Income.UC",
...
saveRDS(LCFS_Benefits_22_24, "LCFS_Benefits_22_24.rds")           
```
...
LCFS_22_Work<-LCFS_22_Work %>% 
  mutate(HRP.Total.Wages.23.LCFS=HRP.Total.Wages.LCFS*wages.inflation.23,
         HRP.Total.Wages.23.LCFS=HRP.Total.Wages.LCFS*wages.inflation.24,
...
LCFS_22_Work.22<-LCFS_22_Work%>% mutate(Year="2021-22")
LCFS_22_Work.23<<-LCFS_22_Work%>% mutate(Year="2022-23")
LCFS_22_Work.24<<-LCFS_22_Work%>% mutate(Year="2023-24")

LCFS_Work_22_24 <- rbind(LCFS_22_Work.22,LCFS_22_Work.23, LCFS_22_Work.24)

```

```{r}
LCFS_Work_22_24 <- LCFS_Work_22_24 %>% 
...
saveRDS(LCFS_Work_22_24, "LCFS_Work_22_24.rds")
```
...
LCFS_Age_21_24 <- rbind(dvper_21_22,dvper_22_23, dvper_23_24)%>% select( -Demographic.HRP.LCFS)
```
...
df_ethnicity_22<-df_ethnicity_HRP %>% left_join(df_ethnicity_HRP_Partner, by=c("case"))%>% rename("Demographic.ethnicity.HRP"=a012p,
